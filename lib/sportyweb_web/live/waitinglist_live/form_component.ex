defmodule SportywebWeb.EventWaitingListLive.FormComponent do
  ...
  def update(assigns, socket) do
    changeset = EventContact.changeset(%EventContact{},
    %{
  ...
  def handle_event("save", %{"event_contact" => params}, socket) do
    ...
    case Repo.insert(EventContact.changeset(%EventContact{}, params)) do
      {:ok, _ec} ->
        {:noreply,
         socket
         |> put_flash(:info, "Kontakt zur Warteliste hinzugefügt.")

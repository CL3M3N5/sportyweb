defmodule SportywebWeb.EquipmentLive.Calendar do
  ...
  @impl true
  def handle_params(%{"id" => equipment_id}, _url, socket) do
    require Logger
    ...
    raw_events = Calendar.list_events_by_equipment(equipment_id, start_date, end_date)
    ...
    {:noreply,
     ...
     |> assign(:linktolistview, ~p"/equipment/#{equipment_id}")

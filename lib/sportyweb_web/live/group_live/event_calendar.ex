defmodule SportywebWeb.GroupLive.Calendar do
  ...
  @impl true
  def handle_params(%{"id" => group_id}, _url, socket) do
    require Logger
    group = Organization.get_group!(group_id)
    ...
    raw_events = Calendar.list_events_by_group(group_id, start_date, end_date)

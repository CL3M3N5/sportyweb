defmodule Sportyweb.Calendar do
  ...
  def list_events_by_group(group_id, view_start_time, view_end_time) do
    query = from(e in Event,
    join: eg in Sportyweb.Calendar.EventGroup,
    on: eg.event_id == e.id,
    ...
    @doc """
  Returns a list of events by group starts after start view.

  ## Examples

      iex> list_events_by_group(group_id, view_start_time)
      [%Event{}, ...]

  """
  def list_events_by_group(group_id, view_start_time) do
    query = from(e in Event,
    join: eg in Sportyweb.Calendar.EventGroup,
    on: eg.event_id == e.id,
    where: eg.group_id == ^group_id,
    ...
    @doc """
  Returns a  list of events between start time and end time by contact.

  ## Examples

      iex> list_events_by_contact(contact_id, view_start_time, view_end_time)
      [%Event{}, ...]

  """
  def list_events_by_contact(contact_id, view_start_time, view_end_time) do
    query = from(e in Event,
    join: ec in Sportyweb.Calendar.EventContact,
    on: ec.event_id == e.id,
    ...
    @doc """
  Returns a list of events by contact starts after start view.

  ## Examples

      iex> list_events_by_contact(contact_id, view_start_time)
      [%Event{}, ...]

  """
  def list_events_by_contact(contact_id, view_start_time) do
    query = from(e in Event,
    join: ec in Sportyweb.Calendar.EventContact,
    on: ec.event_id == e.id,
    where: ec.contact_id == ^contact_id,
